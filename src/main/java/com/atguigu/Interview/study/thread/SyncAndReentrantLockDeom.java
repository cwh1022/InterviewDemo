 ...
 *
 * 题目： synchronized和Lock的区别？用新的Lock有什么好处
 * 1. 原始构成
 ...
 *
 * 2. 使用方法
 *      synchronized不需要用户区手动释放锁，当synchronized代码执行完成后系统会自动让线程释放对锁的占用
 *      ReentrantLock则需要用户去手动释放锁若没有释放锁，就有可能导致出现死锁现象。
...
public class SyncAndReentrantLockDeom {
